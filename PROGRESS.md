...
### v2.0「风有了形状」（本轮 T56–T62 全部落地，MAIN_EXIT=0）
- 风语系统：8 风语 + 4 旋律，G 键风琴演奏，听风点收集
- 空中航线：热气球 → 浮岛农场 / 星风崖；世界地图节点与解锁
- 浮岛温室：反季种植（FarmPlot.allow_any_season）
- 风蚀迷宫：随机 3 层，Boss 掉星风铃部件，不掉存档物
- 匠心 QTE：合成前节奏条，完美加成产量
- 羁绊：告白(G)→伴侣→婚礼(H)；议事会修缮木桥/广场/石径
- 节令联赛：5 杯积分 + 奖杯架 + 本地榜（镇上可查）
- 系统改进：背包类型筛选、闲日长、高对比/缩放/减动效、云存档导出导入
